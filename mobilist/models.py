...
class Proprietaire(Base):
    ...
    logements = relationship("Logement",
                             secondary="AVOIR",
                             back_populates="proprietaires")
...
class Logement(Base):
    ...
    proprietaires = relationship("Proprietaire",
                                 secondary="AVOIR",
                                 back_populates="logements")

    def __init__(self, id_logement, nom_logement, type_logement,
                 adresse_logement, desc_logement):
        """Init d'un logement
...
class User(Base, UserMixin):
    ...
    id_user = Column(Integer,
                     ForeignKey("PROPRIETAIRE.ID_PROPRIO"),
                     name="ID_PROPRIO")
    proprio = relationship('Proprietaire',
                           back_populates='user',
                           uselist=False)
